        ...
        stage('Build-Image') {
            steps {
                ...
                script {
                    ...
                    def response = sh(script: 'curl https://artifactory.platformdxc-mg.com/artifactory/lma-maven/maven-org/mybatis/maven-jpetstore/maven-6.0.2-SNAPSHOT/maven-jpetstore-maven-6.0.2-20200616.154713-4.war', returnStdout: true)
